...
class fvOptions:
    def __init__(self, model: TurbineModel, run_options: dict):
        ...
        self.origin = [0, 0, 0]
        self.axis = [float(np.cos(np.radians(run_options.tilt_angle))), 0, float(np.sin(np.radians(run_options.tilt_angle)))]
        ...
        self.hub_element_data = [f"(0 {model.hub.radius} {model.hub.radius})",
